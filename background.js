...
//   codeStr += 'classNames.push("Banner-image");';//广告
...
chrome.runtime.onInstalled.addListener(function() {
  ...
  chrome.declarativeContent.onPageChanged.removeRules(undefined, function() {
    chrome.declarativeContent.onPageChanged.addRules([{
      ...
      actions: [new chrome.declarativeContent.ShowPageAction(),new chrome.declarativeContent.RequestContentScript({js:["test.js"]})]
      // actions: ["console.log(1234)"]
    }]);
  });
});
